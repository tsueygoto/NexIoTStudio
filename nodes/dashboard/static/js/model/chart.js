...
App.Model.Chart = ( function() {
  ...
  ChartDatasource.prototype.buttonRequest = function( start , end , callback ) {
    console.log("button request!!!");
    //this.datasource.requestHistoryData( this.parent , start , end , callback );
    this.datasource.buttonRequest( this.parent , start , end , callback );
  };

    ChartDatasource.prototype.clickRequest = function( data , callback ) {
        console.log("click request!!!");
        this.datasource.clickRequest( this.parent , data , callback );
    };

    /**
     *
     */
    ChartDatasource.prototype.dataBroker = function( data ) {
        console.log("data Broker !!!");
        this.datasource.dataBroker( this.parent , data );
    };
    ...
    Chart.prototype.serialize = function()
    {
        ...
        {
            if (this.datasources.hasOwnProperty(i)) {
    ...
    Chart.prototype.unserialize = function( data )
    {
        ...
        {
            if (data.datasources.hasOwnProperty(i)) {
