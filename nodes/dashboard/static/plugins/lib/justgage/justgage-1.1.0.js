...
JustGage = function(config) {
    ...
    obj.config = {
        ...
        // level border color
        borderColor : obj.kvLookup('borderColor', config, dataset, 'none'),
        
        // gauge middle mode
        middleMode : obj.kvLookup('middleMode', config, dataset, false),
    };
    ...
    obj.canvas.customAttributes.pki = function (value, min, max, w, h, dx, dy, gws, donut, middleMode) {
        ...
        if (donut) {
            ...
            if (!middleMode) {
                ...
                else
                {
                    path = "M" + Cx + "," + (Cy - Ri) + " ";
                    path += "L" + Cx + "," + (Cy - Ro) + " ";
                    path += "A" + Ro + "," + Ro + " 0 0 0 " + Xo + "," + Yo + " ";
                    path += "L" + Xi + "," + Yi + " ";
                    path += "A" + Ri + "," + Ri + " 0 0 1 " + Cx + "," + (Cy - Ri) + " ";
                    path += "Z ";
                }
            }
