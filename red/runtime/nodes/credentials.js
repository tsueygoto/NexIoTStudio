...
var api = module.exports = {
    ...
    encryptCredentials: function(Key, credential) {
        var result = null;
        try {
            log.debug("red/runtime/nodes/credentials.encrypt : encrypting");
            ...
            result = {"$":initVector.toString('hex') + cipher.update(JSON.stringify(credential), 'utf8', 'base64') + cipher.final('base64')};
        } catch(err) {
