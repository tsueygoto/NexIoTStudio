...
var oneclickdeployer = require("./oneclickdeployer");
...
function init(_server,_runtime) {
    ...
    if (settings.httpAdminRoot !== false) {
        ...
        // One-Click Deployer
        //adminApp.get("/oneclickdeployer",needsPermission("oneclickdeployer.read"),oneclickdeployer.get,errorHandler);
        adminApp.get("/oneclickdeployer/:func",needsPermission("oneclickdeployer.write"),oneclickdeployer.get,errorHandler);
        adminApp.post("/oneclickdeployer/:func",needsPermission("oneclickdeployer.write"),oneclickdeployer.post,errorHandler);
